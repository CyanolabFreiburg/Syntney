...
def main():
    ...
    parser.add_argument("--use_sob_weights", help="If True uses sum of branch weights for Synteny Value calculation. "
                                                  "Default is False", type=bool, default=False)
    parser.add_argument("-d", "--sqlite_db", help="Path to SQLite DB", type=str, default="/home/steffen/projects/Dominik_Master_Thesis/Synteny_Network/packages/GENBANK_GROPER_SQLITE/mySQLiteDB_new.db")
    parser.add_argument("-s", "--sqlite_script", help="", type=str, default="/home/steffen/projects/Dominik_Master_Thesis/Synteny_Network/packages/GENBANK_GROPER_SQLITE/genbank_groper_sqliteDB.py")
